 ...
 * @property {Object} coaChildren
 */
const DataEntryTransactionEntryOut = {
  coaChildren: { // map[string]string
  }, // map[string]string
}
/**
...
/**
 * @typedef {Object} TenantAdminManualJournalEditIn
 * @property {String} cmd
 * @property {number} transactionJournal.id
 * @property {String} transactionJournal.tenantCode
 * @property {number} transactionJournal.coaId
 ...
 * @property {number} transactionJournal.transactionTemplateId
 */
const TenantAdminManualJournalEditIn = {
  cmd: '', // string
  transactionJournal: { // rqFinance.TransactionJournal
    id: 0, // uint64
    tenantCode: '', // string
...
/**
 * @typedef {Object} TenantAdminManualJournalEditOut
 * @property {number} transactionJournal.id
 * @property {String} transactionJournal.tenantCode
 * @property {number} transactionJournal.coaId
 * @property {number} transactionJournal.debitIDR
 ...
 * @property {number} transactionJournal.transactionTemplateId
 */
const TenantAdminManualJournalEditOut = {
  transactionJournal: { // rqFinance.TransactionJournal
    id: 0, // uint64
    tenantCode: '', // string
    coaId: 0, // uint64
...
/**
 * @callback TenantAdminManualJournalEditCallback
 * @param {TenantAdminManualJournalEditOut} o
 * @returns {Promise}
 */
/**
 * @param  {TenantAdminManualJournalEditIn} i
 * @param {TenantAdminManualJournalEditCallback} cb
 * @returns {Promise}
 */
exports.TenantAdminManualJournalEdit = async function TenantAdminManualJournalEdit( i, cb ) {
  return await axios.post( '/tenantAdmin/manualJournal/edit', i ).
    then( wrapOk( cb ) ).
    catch( wrapErr( cb ) )
}
