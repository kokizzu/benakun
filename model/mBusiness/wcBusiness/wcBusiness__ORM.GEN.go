...
// func (i *InventoryChangesMutator) DoUpsert() bool { //nolint:dupl false positive
//	arr := i.ToArray()
...
//		A.X{`=`, 13, i.ExpenseId},
//	})
//	return !L.IsError(err, `InventoryChanges.DoUpsert failed: `+i.SpaceName()+ `\n%#v`, arr)
// }
